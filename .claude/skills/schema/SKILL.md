...
3. MCP `get_context("schema")`로 스키마 관련 규칙을 조회한다.
4. 기존 컨벤션에 맞춰 CREATE TABLE 문을 작성한다.

## 컨벤션 (schema.sql 기반)

- 테이블명: `tb_` 접두사
- PK: `id INT NOT NULL AUTO_INCREMENT`
- 날짜: `VARCHAR(14)` (yyyyMMddHHmmss 형식, DATETIME/TIMESTAMP 금지)
